 ...
 * It is defined by a message, an optional code, an execute method to "do" theaction.<BR>
...
public interface Action {
	...
	/**
	 * Code of the action (may be used to identify the action among an actionlist).
	 *
